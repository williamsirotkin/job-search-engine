        ...
        <div>
            ...
            <div class="container">
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector/Travel"> Travel </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector/Food"> Food </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector/Tech"> Tech </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector/Finance"> Finance </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector/Healthcare"> Healthcare </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector/Automotive"> Automotive </Link></button>
                </div>
            </div>
        </div>
    )
