        ...
        <div>
            ...
            <div class="container">
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector"> Travel </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector"> Food </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector"> Tech </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector"> Finance </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector"> Healthcare </Link></button>
                </div>
                <div class="item">
                    ...
                    <button class="btn"><Link class = "link" to="/sector"> Automotive </Link></button>
                </div>
            </div>
        </div>
    )
